...
export type OverriddenVolumeResourceId<T extends VolumeName> =
  `${T}.${VolumeOverride}`;
...
export type I18nStorageVolume<T extends VolumeData = VolumeData> =
  | T
  | Promise<T>;

export type I18nStorageVolumeGetter<T extends VolumeData> =
  () => I18nStorageVolume<T>;
...
export type GetI18nStorageVolumeNames<T extends I18nStorage> =
  keyof (T extends I18nStorage<infer I> ? I : never) & string;

export type GetI18nStorageVolumeData<
  TStore extends I18nStorage,
  TVolumeName extends GetI18nStorageVolumeNames<TStore>,
> =
  TStore[DictionaryId][TVolumeName] extends I18nStorageVolumeGetter<infer T>
    ? T
    : never;
